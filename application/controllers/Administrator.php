...
class Administrator extends CI_Controller {
    ...
    // Controler Modul Kepala
    function kepala(){
		cek_session_akses('kepala',$this->session->id_session);
        if ($this->session->level=='admin'){
            $data['record'] = $this->model_app->view_ordering('kepala','id_kepala','DESC');
        }else{
            $data['record'] = $this->model_app->view_where_ordering('kepala',array('username'=>$this->session->username),'id_kepala','DESC');
        }
		$this->template->load('administrator/template','administrator/mod_kepala/view_kepala',$data);
	}
    ...
    function tambah_kepala(){
		...
		if (isset($_POST['submit'])){
            ...
            $this->model_app->insert('kepala',$data);
			redirect('administrator/kepala');
		}else{
			$this->template->load('administrator/template','administrator/mod_kepala/view_kepala_tambah');
		}
	}
