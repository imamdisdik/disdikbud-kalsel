    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="#" style="margin-right:10px; text-decoration:none;">Haloo Selamat datang di halaman administrator Dinas Pendidikan dan Kebudayaan Provinsi Kalimantan Selatan</a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="http://disdikbud.kalselprov.go.id:9000" style="color: rgb(243, 156, 18);">disdikbud.kalselprov.go.id</a>
        </div>
      <?php } ?>
