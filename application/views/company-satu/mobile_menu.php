        ...
        <div class='td-menu-socials-wrap'>
            <div class='td-menu-socials'>
                <span class='td-social-icon-wrap'>
                    <a target='_blank' href="<?php echo $bagi[0]; ?>" title='Facebook'> <i class="td-icon-font td-icon-facebook"></i> </a>
                </span>
                <span class='td-social-icon-wrap'>
                    <a target='_blank' href="<?php echo $bagi[1]; ?>" title="Google+"><i class="td-icon-font td-icon-googleplus"></i></a>
                </span>
                <span class='td-social-icon-wrap'>
                    <a target='_blank' href="<?php echo $bagi[2]; ?>" title='Instagram'><i class="td-icon-font td-icon-instagram"></i></a>
                </span>
                <span class='td-social-icon-wrap'>
                    <a target='_blank' href="<?php echo $bagi[3]; ?>" title='Twitter'><i class="td-icon-font td-icon-twitter"></i></a>
                </span>
                <span class='td-social-icon-wrap'>
                    <a target='_blank' href="<?php echo $bagi[4]; ?>" title='Youtube'><i class="td-icon-font td-icon-youtube"></i></a>
                </span> 
            </div>
